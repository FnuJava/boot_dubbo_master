...
import com.boot.dubbo.common.util.DigestUtil;
import com.boot.dubbo.common.util.RegexUtil;
...
import com.boot.dubbo.provider.util.UserContextUtil;
...
public class UserServiceImpl  implements UserService {
    ...
    public static void	main(String args[]){
    	...
    	com.boot.dubbo.service.userRight.UserService userservice = context.getBean(com.boot.dubbo.service.userRight.UserService.class);
